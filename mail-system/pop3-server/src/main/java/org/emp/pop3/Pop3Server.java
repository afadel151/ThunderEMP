...
public class Pop3Server {
    ...
    public Pop3Server() { this(DEFAULT_PORT); }
    public Pop3Server(int port) { this.port = port; }

    public void setLogListener(Pop3LogListener l)   { this.logListener  = l; }
    public void setAuthenticator(Pop3Authenticator a) { this.authenticator = a; }
    public void setMailStorage(Pop3MailStorage s)   { this.mailStorage  = s; }
